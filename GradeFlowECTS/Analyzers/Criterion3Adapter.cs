...
{
    public class Criterion3Adapter : ICriterionAnalyzer
    {
        public int MaxScore { get; }

        private readonly Criterion3Analyzer _analyzer;

        public Criterion3Adapter(int maxScore)
        {
            MaxScore = maxScore;
            _analyzer = new Criterion3Analyzer(maxScore);
        }
